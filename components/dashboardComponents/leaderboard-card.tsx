        ...
        <Card className="border-gray-600/60 bg-gray-800/70 py-4">
            ...
            <CardContent className="space-y-3 px-4">
                {data.map((entry) => (
                    <div
                        key={entry.id}
                        className="flex items-center justify-between rounded-md border border-gray-700/80 bg-gray-900/40 px-3 py-2 transform transition-all duration-150 hover:-translate-y-0.5 hover:bg-gray-900/60 hover:shadow-md"
                    >
                        <div className="flex min-w-0 items-center gap-3">
                            ...
                            <div className="min-w-0">
                                <p className="truncate text-sm font-semibold text-gray-400">{entry.name}</p>
